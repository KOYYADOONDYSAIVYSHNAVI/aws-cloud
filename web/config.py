...
class Config(object):
  ...
  AWS_SNS_JOB_REQUEST_TOPIC = \
    "arn:aws:sns:us-east-1:659248683008:koyya_job_requests"
  AWS_SNS_JOB_COMPLETE_TOPIC = \
    "arn:aws:sns:us-east-1:659248683008:koyya_job_results"
  AWS_SNS_JOB_RESTORE_TOPIC = \
    "arn:aws:sns:us-east-1:659248683008:koyya_glacier_restore"
  AWS_SNS_JOB_THAW_TOPIC = \
    "arn:aws:sns:us-east-1:659248683008:koyya_glacier_thaw"

  # Change the table name to your own
  AWS_DYNAMODB_ANNOTATIONS_TABLE = "koyya_annotations"

  # Change the email address to your username
  MAIL_DEFAULT_SENDER = "koyya@mpcs-cc.com"
